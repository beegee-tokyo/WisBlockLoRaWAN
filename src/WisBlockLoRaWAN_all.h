...
#define DEF_FW_VER "WB_BM_RAK3312_" WISBLOCK_LORAWAN_STRINGIFY(WISBLOCK_LORAWAN_VERSION_MAJOR) \
"." WISBLOCK_LORAWAN_STRINGIFY(WISBLOCK_LORAWAN_VERSION_MINOR) \
"." WISBLOCK_LORAWAN_STRINGIFY(WISBLOCK_LORAWAN_VERSION_PATCH)
#elif defined(ARDUINO_ARCH_RP2040)
#define DEF_FW_VER "WB_BM_RAK11310_" WISBLOCK_LORAWAN_STRINGIFY(WISBLOCK_LORAWAN_VERSION_MAJOR) \
"." WISBLOCK_LORAWAN_STRINGIFY(WISBLOCK_LORAWAN_VERSION_MINOR) \
"." WISBLOCK_LORAWAN_STRINGIFY(WISBLOCK_LORAWAN_VERSION_PATCH)
#else
#endif
